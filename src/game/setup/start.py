"""
Game starting module handling the initialization of games and sending roles to players.
"""
import logging
...
from src.game.roles.role_manager import role_descriptions, role_factions
from src.game.state_machine import state_machine, GameState

logger = logging.getLogger("Mafia Bot GameSetup.Start")
...
async def start_game(update: ContextTypes.DEFAULT_TYPE, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await state_machine.transition_to(update, context, game_id, GameState.NIGHT)
