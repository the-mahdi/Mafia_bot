"""
Game creation module handling the creation of new games in the database.
"""
import sqlite3
import logging
import uuid
...
from src.game.roles.role_manager import available_roles
from src.utils.context import clear_user_data

logger = logging.getLogger("Mafia Bot GameSetup.Create")

async def create_game(update: ContextTypes.DEFAULT_TYPE, context: ContextTypes.DEFAULT_TYPE) -> None:
    """
    Creates a new game with a unique passcode and adds it to the database.
